...
#define EPMO2L      (0x12)
#define EPMO2H      (0x13)
#define ERXFCON2    (0x14)
#define ERXFCON3    (0x15)
#define ERXFCON4    (0x16)
#define EIE         (0x17)
#define ESTATCLR    (0x1A)
#define EIR         (0x1B)
#define ESTAT       (0x1D)
#define ECON2       (0x1E)
#define ECON1       (0x1F)
 ...
 *============================================================================*/
#define MISTAT      (0x0A)
#define MIRESULT    (0x0C)

/* MAC address registers (Bank 3, non-banked) */
#define MAADR0_B3   (0x00)
#define MAADR1_B3   (0x01)
#define MAADR2_B3   (0x02)
#define MAADR3_B3   (0x03)
#define MAADR4_B3   (0x04)
#define MAADR5_B3   (0x05)
