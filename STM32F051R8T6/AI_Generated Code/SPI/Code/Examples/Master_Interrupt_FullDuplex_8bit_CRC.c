/**
 * @file    Master_Interrupt_FullDuplex_8bit_CRC.c
 * @brief   SPI Master - Full Duplex, 8-bit Data Frame, CRC Enabled, Interrupt Mode
 * @author  AI Generated
 * @date    2026-03-02
 * 
...
/**
 * @brief  Initialize SPI1 as Master with CRC and interrupts
 *         - Full duplex mode
 *         - 8-bit data frame
 *         - CRC enabled
