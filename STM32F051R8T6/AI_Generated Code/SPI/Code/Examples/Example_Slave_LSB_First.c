/**
 * @file Example_Slave_LSB_First.c
 * @brief SPI Slave Mode - LSB First Transfer Example
 * @description This example demonstrates SPI slave with LSB-first frame format.
 */
...
uint8_t tx_buffer[BUFFER_SIZE] = {0x12, 0x34, 0x56, 0x78};
...
int main(void)
{
    ...
    printf("SPI Slave - LSB First Example\r\n");
    printf("============================\r\n\r\n");
    
    printf("Waiting for master (LSB-first)...\r\n");
...
//============================================================================
// SPI Initialization - Slave LSB First
//============================================================================

void SPI1_Init_Slave_LSB(void)
{
    hspi1.Instance = SPI1;
