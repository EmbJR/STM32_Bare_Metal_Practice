 ...
 * ---------------------------------------------------------------
 *  Brings the system up to 480 MHz on HSI via PLL1, enables a few
 *  peripheral clocks and sits in a tight loop.
 *
...
int main(void)
{
    /* 1) Configure the system clock to 480 MHz from HSI */
